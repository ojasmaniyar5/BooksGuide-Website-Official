...
?>
	...
	<section class="book-list">
            <article class="book">
			<img src="rich.jpg" alt="Book Title">
                <h2>Rich Dad Poor Dad.</h2>
                <p>Author:  Robert T. Kiyosaki and Sharon Lechter.</p>
                <p>Price: $6.82</p>
		</article>
		...
		<article class="book">
            	...
            	<a href="payment1.html"><button>Cancel</button></a><br><br>
            	<a href="new.html"><button>Back To Home</button></a>
            	<a href="books.html"><button>Back To Book-list</button></a><br><br>

		</article>
	</section>
	<footer>
        <p>&copy; 2024 BooksGuide. All rights reserved.</p>
    </footer>
